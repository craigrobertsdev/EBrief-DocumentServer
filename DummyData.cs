...
public static class DummyData {
    ...
    static readonly List<CaseFileDocument> _caseFileDocuments = [
        new CaseFileDocument {
    ...
    static readonly List<OccurrenceDocument> _occurrenceDocuments = [
        new OccurrenceDocument {
    ...
    static List<Defendant> RandomiseDefendants() {
        var defendants = Enumerable.Range(1, 30)
    ...
    private static readonly List<string> _factsOfCharge = [
        ...
        "BRIEF OVERVIEW: On the 12th day of July 2024 in Adelaide, the accused John Doe drove a motor vehicle on a public road while disqualified from holding or obtaining a driver's license. \n\nPOLICE: Law enforcement officers conducting routine traffic patrols in Adelaide on the evening of July 12th, 2024, observed a vehicle being driven erratically on a public road. Upon signaling the driver to pull over, they discovered that the driver, John Doe, was disqualified from holding or obtaining a driver's license due to prior traffic offenses. Doe was immediately arrested and charged with driving while disqualified, a serious traffic violation. \n\nACCUSED: John Doe, a 30-year-old resident of Adelaide, acknowledged his disqualification from driving but claimed ignorance of the legal consequences. He expressed regret for his actions and accepted responsibility for the offense, pledging to comply with the law in the future.",
        "BRIEF OVERVIEW: On the 8th day of June 2024 in Adelaide, the accused Betty Ingridson deceived a local business owner, Fred Smith, by posing as a customer and stealing $500 cash from the register. \n\nVICTIM: Fred Smith, a 40-year-old small business owner in Adelaide, was operating his convenience store on the morning of June 8th, 2024. Betty Ingridson entered the store and engaged Smith in conversation, distracting him while she surreptitiously pocketed $500 from the cash register. \n\nPOLICE: Fred Smith discovered the missing cash during a routine register check and reviewed the store's security footage, which captured Ingridson's theft. He promptly reported the incident to the Adelaide Police Department, providing a description of the suspect and the stolen amount. Law enforcement officers launched an investigation into the theft, identifying Ingridson as the perpetrator based on witness testimonies and video evidence. \n\nIngridson was located and apprehended by the police, who recovered the stolen cash from her possession. She was arrested and charged with deception, with the stolen money returned to Smith. \n\nACCUSED: Betty Ingridson, a 35-year-old resident of Adelaide, initially denied any involvement in the theft when questioned by the authorities. However, when presented with irrefutable evidence of her actions, Ingridson confessed to the crime and expressed remorse for her behavior. She cited financial difficulties and personal struggles as contributing factors to her deceptive actions.",
        ];
